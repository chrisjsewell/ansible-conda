...
def _main():
    ...
    module = AnsibleModule(
        argument_spec={
            "packages": {"required": True, "type": "list", "elements": "str"},
            "executable": {
                "type": "path",
                "default": "~/.conda/bin/mamba",
                "required": False,
            },
            "env": {"default": None, "required": False, "type": "str"},
            "channels": {
                "default": None,
                "required": False,
                "type": "list",
...
def find_conda(exec_str: t.Optional[str]) -> str:
    """
    ...
    raise CondaExecutableNotFoundError(exec_str or "conda")
